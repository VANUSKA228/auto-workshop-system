...
export default function CreateOrderPage() {
  ...
  useEffect(() => { servicesApi.list().then((r) => setServices(r.data)); }, []);
  ...
  return (
    <div className="max-w-xl mx-auto">
      <h1 className="text-2xl font-bold text-primary-dark mb-6">Новая заявка</h1>
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
        ...
        <div className="flex gap-3">
          <button type="submit" className="flex-1 py-3 bg-primary text-white rounded-xl hover:bg-primary-dark transition font-semibold">
            Далее — к оплате →
          </button>
